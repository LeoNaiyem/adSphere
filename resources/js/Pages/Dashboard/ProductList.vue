...
<template>
  ...
  <Container>
    ...
    <div class="flex items-center gap-2 text-sm text-gray-500 mb-6">
      <Link :href="route('dashboard')" class="hover:text-primary-600 flex items-center gap-1">
        ...
        <table class="w-full text-sm text-left text-gray-600">
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-4 py-3 font-semibold text-gray-800">{{ product.price }}</td>
              <td class="px-4 py-3">{{ product.user?.name ?? "N/A" }}</td>
